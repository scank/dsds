...
//		0.003533495923377968916945235378079814836                                                     
	...
	{//100hz
		ScaleValue = 0.021883851967943023647533706821377563756f * 0.019036831587823873496168047836363257375f;		/*放缩系数 */
		IIRCoeffs32LP[3]= 1.700964331943525920110005245078355073929f;
		IIRCoeffs32LP[4]= -0.788499739815297973066776648920495063066f;
		IIRCoeffs32LP[8]= 1.479674216931193386770360120863188058138f;
		IIRCoeffs32LP[9]= -0.555821543282489005655122582538751885295f;
		arm_biquad_cascade_df1_init_f32(&S1, IIRnumStages, (float32_t *)&IIRCoeffs32LP[0],(float32_t *)&IIRStateF32_1[0]);
		arm_biquad_cascade_df1_init_f32(&S2, IIRnumStages, (float32_t *)&IIRCoeffs32LP[0],(float32_t *)&IIRStateF32_2[0]);
		arm_biquad_cascade_df1_init_f32(&S3, IIRnumStages, (float32_t *)&IIRCoeffs32LP[0],(float32_t *)&IIRStateF32_3[0]);
		arm_biquad_cascade_df1_init_f32(&S4, IIRnumStages, (float32_t *)&IIRCoeffs32LP[0],(float32_t *)&IIRStateF32_4[0]);
		...
		arm_biquad_cascade_df1_init_f32(&S6, IIRnumStages, (float32_t *)&IIRCoeffs32LP[0],(float32_t *)&IIRStateF32_6[0]);
//		SOS Matrix:                                                                                      
//		1  2  1  1  1.700964331943525920110005245078355073929  -0.788499739815297973066776648920495063066
//		1  2  1  1  1.479674216931193386770360120863188058138  -0.555821543282489005655122582538751885295
//																										 
//		Scale Values:                                                                                    
//		0.021883851967943023647533706821377563756                                                        
//		0.019036831587823873496168047836363257375   
	}
}
